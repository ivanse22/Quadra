...
import { IconBuildingBank, IconSend, IconSmartphone } from '../../ui/Icons'

const CONNECT_OPTIONS = [
  { id: 'bancolombia', label: 'Bancolombia', Icon: IconBuildingBank },
  { id: 'nequi',       label: 'Nequi',       Icon: IconSmartphone  },
  { id: 'wise',        label: 'Wise',         Icon: IconSend        },
      ...
      <div style={{ width: '100%', marginTop: 'var(--s5)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--s2)', marginBottom: 'var(--s4)' }}>
          {CONNECT_OPTIONS.map(opt => (
            ...
            >
              {opt.Icon ? (
                <span style={{ color: 'var(--txt-m)', display: 'flex' }}><opt.Icon size={22} /></span>
              ) : (
